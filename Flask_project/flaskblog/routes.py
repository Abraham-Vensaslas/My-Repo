...
def new_post():
    form=PostForm()
    if form.validate_on_submit():
        post=Post(Name=form.Name.data, p_link=form.p_link.data,Club=form.Club.data, link=form.link.data,Country=form.Country.data, author=current_user)
        db.session.add(post)
        db.session.commit()
...
def update_post(post_id):
    ...
    if form.validate_on_submit():
        ...
        post.p_link  = form.p_link.data
        post.Club = form.Club.data
        ...
        form.p_link.data = post.p_link
        form.Club.data = post.Club
